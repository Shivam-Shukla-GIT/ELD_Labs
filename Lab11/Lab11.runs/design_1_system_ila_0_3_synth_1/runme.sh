...
HD_PWD='D:/Drive_D/ELD2023/Lab11/Lab11.runs/design_1_system_ila_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_0_3.tcl
