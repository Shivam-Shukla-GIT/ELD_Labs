...
HD_PWD='F:/ELD2023/Midsem_Lab_Exam_A/Midsem_Lab_Exam_A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vio_wrappper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vio_wrappper.tcl -notrace
