...
HD_PWD='F:/ELD2023/Midsem_Lab_Exam_A/Midsem_Lab_Exam_A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vio_wrappper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vio_wrappper.tcl
