...
HD_PWD='D:/Drive D/ELD2023/Lab6_HW/Lab6_HW.runs/FA_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_add.tcl
