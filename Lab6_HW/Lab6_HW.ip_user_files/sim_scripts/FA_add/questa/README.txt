...
#
# Generated by export_simulation on Sat Oct 14 19:21:06 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './FA_add.sh' script.
...
./FA_add.sh -noclean_files

For more information on the script, please type './FA_add.sh -help'.
