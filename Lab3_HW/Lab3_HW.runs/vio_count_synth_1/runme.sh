...
HD_PWD='F:/ELD2023/Lab3_HW/Lab3_HW.runs/vio_count_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_count.tcl
