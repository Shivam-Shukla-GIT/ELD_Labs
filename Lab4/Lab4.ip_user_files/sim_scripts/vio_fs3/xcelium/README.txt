...
#
# Generated by export_simulation on Tue Sep 12 10:04:52 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './vio_fs3.sh' script.

./vio_fs3.sh -reset_run
...
./vio_fs3.sh -noclean_files

For more information on the script, please type './vio_fs3.sh -help'.
