...
HD_PWD='F:/ELD2023/Lab2_FA_HW/Lab2_FA_HW.runs/vio_FA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_FA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_FA.tcl
