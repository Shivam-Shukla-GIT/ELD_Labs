...
HD_PWD='F:/ELD2023/Lab4_HW/Lab4_HW.runs/clk_cmt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_cmt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_cmt.tcl
