...
HD_PWD='D:/Drive_D/ELD2023/Lab10_HW/Lab10_HW.runs/design_fft_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_fft_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_fft_floating_point_0_0.tcl
