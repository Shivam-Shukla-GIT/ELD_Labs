...
HD_PWD='D:/Drive_D/ELD2023/Lab10_HW/Lab10_HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_fft_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_fft_wrapper.tcl -notrace
