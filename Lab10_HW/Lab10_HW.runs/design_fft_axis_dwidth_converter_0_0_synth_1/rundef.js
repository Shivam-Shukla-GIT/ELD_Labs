...
ISEStep( "vivado",
         "-log design_fft_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_fft_axis_dwidth_converter_0_0.tcl" );
