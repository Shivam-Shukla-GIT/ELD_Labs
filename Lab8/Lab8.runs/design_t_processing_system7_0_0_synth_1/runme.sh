...
HD_PWD='D:/Drive D/ELD2023/Lab8/Lab8.runs/design_t_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_t_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_t_processing_system7_0_0.tcl
