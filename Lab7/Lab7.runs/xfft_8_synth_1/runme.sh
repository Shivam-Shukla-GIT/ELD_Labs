...
HD_PWD='D:/Drive D/ELD2023/Lab7/Lab7.runs/xfft_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_8.tcl
