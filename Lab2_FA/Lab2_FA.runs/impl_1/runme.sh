...
HD_PWD='F:/ELD2023/Lab2_FA/Lab2_FA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_adderHW.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_adderHW.tcl -notrace
