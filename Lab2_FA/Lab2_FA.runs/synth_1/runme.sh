...
HD_PWD='F:/ELD2023/Lab2_FA/Lab2_FA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_adderHW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_adderHW.tcl
