...
HD_PWD='D:/Drive_D/ELD2023/Endsem2021/Endsem2021.runs/design_1_floating_point_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_floating_point_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_floating_point_2_0.tcl
