...
HD_PWD='F:/ELD2023/Lab5_Hw_approach2/Lab5_Hw_approach2.runs/vio_fs3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_fs3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_fs3.tcl
