...
HD_PWD='D:/Drive D/ELD2023/Lab_7_HW_2/Lab_7_HW_2.runs/floating_point_sqrt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_sqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_sqrt.tcl
