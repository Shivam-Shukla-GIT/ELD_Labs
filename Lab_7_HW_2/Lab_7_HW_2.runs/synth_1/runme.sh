...
HD_PWD='D:/Drive_D/ELD2023/Lab_7_HW_2/Lab_7_HW_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_arith.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_arith.tcl
