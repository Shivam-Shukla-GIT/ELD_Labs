...
#
# Generated by export_simulation on Sat Oct 28 14:40:32 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './floating_point_log.sh' script.

./floating_point_log.sh -reset_run
...
./floating_point_log.sh -noclean_files

For more information on the script, please type './floating_point_log.sh -help'.
