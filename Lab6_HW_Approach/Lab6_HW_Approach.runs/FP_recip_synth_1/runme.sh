...
HD_PWD='D:/Drive D/ELD2023/Lab6_HW_Approach/Lab6_HW_Approach.runs/FP_recip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_recip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_recip.tcl
